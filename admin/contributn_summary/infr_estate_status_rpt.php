                                    ...
                                    echo "<tr readonly>";
                                      // echo "<td>" . $row['entry'] . "</td>";
                                       // echo "<td>" . $row['vdate'] . "</td>";
                                        ...
                                        echo "<td>" . $row['contr'] . "</td>";
                                        echo "<td>" . $row['outst'] . "</td>";
                                        echo "<td>" . $infr_fixed_amount . "</td>";
                                        echo "<td>" . $row['paid'] . "</td>";
                                        echo "<td>" . ($infr_fixed_amount - $row['paid']) . "</td>";
