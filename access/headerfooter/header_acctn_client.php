        ...
        <div class="container"><a class="navbar-brand" href="#">RAMSME</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">Payment Status</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/print_templates/security.php">Security</a>
                            <a class="dropdown-item" href="/print_templates/infrastructure.php">Infrastructure</a>
                        </div>
                    </li>
